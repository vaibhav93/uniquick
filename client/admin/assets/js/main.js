...
function ($rootScope, $state, $stateParams,Permission,Authorize,$q,$templateCache) {
    ...
    Permission.defineRole('admin',function(stateParams){
        ...
        return deferred.promise;
    }).defineRole('supervisor',function(stateParams){
        var deferred = $q.defer();
        Authorize.getRole(deferred,'supervisor');
        $rootScope.role= 'supervisor';
        return deferred.promise;
    }).defineRole('technician',function(stateParams){
        var deferred = $q.defer();
        Authorize.getRole(deferred,'technician');
        $rootScope.role= 'technician';
        return deferred.promise;
    });
