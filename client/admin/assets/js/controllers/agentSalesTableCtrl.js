 ...
 */
app.controller('agentSalesTableCtrl', ["$scope", "$localStorage", "usSpinnerService", "$location", "$filter", "$timeout", "Upload", "ngTableParams", "Sale", "UQUser", "$q", "$modal", "$stateParams",
